...
> **To save as a PDF:** click the orange **Save as PDF** button — your browser's print dialogue opens; keep A4 and choose *Save as PDF* as the destination (or press **Cmd/Ctrl + P**). In Claude/ChatGPT the report opens as a live artifact/canvas; if your tool can't render HTML, copy the code into a file called `fortnight-audit.html` and open it in any browser.
...
<style>
  ...
  *{box-sizing:border-box;}
  ...
  /* ---------- DOWNLOAD BAR ---------- */
  .toolbar{position:fixed; right:22px; bottom:22px; z-index:50; display:flex; flex-direction:column; align-items:flex-end; gap:8px;}
  .toolbar .hint{background:#fff; border:1px solid var(--line); color:var(--ink-soft); font-size:11.5px; line-height:1.45; padding:7px 11px; border-radius:10px; box-shadow:var(--shadow); max-width:250px; text-align:right;}
  ...
  table.scale-table{width:100%; border-collapse:collapse; font-size:13px; color:var(--ink-soft);}
  table.scale-table td{padding:7px 0; border-bottom:1px dashed var(--line); vertical-align:baseline;}
  table.scale-table tr:last-child td{border-bottom:none;}
  table.scale-table td.sw{width:17px; padding-right:6px;}
  table.scale-table td.lvl{white-space:nowrap; width:1%; padding-right:12px; color:var(--ink); font-weight:600;}
  table.scale-table i{display:inline-block; width:11px; height:11px; border-radius:3px; position:relative; top:1px;}
...
<div class="toolbar">
  <span class="hint">Opens your browser&rsquo;s print dialogue &mdash; choose <strong>Save as PDF</strong> as the destination (A4).</span>
  <div class="btns">
...
{{RADAR_DOTS}}
      ...
      <div>
        <table class="scale-table">
          <tr><td class="sw"><i class="sw-unseen"></i></td><td class="lvl">Unseen</td><td>no real picture &mdash; running on assumption</td></tr>
          <tr><td class="sw"><i class="sw-strained"></i></td><td class="lvl">Strained</td><td>visible signs of depletion or erosion</td></tr>
          <tr><td class="sw"><i class="sw-holding"></i></td><td class="lvl">Holding</td><td>ticking over, but effortful or fragile</td></tr>
          <tr><td class="sw"><i class="sw-steady"></i></td><td class="lvl">Steady</td><td>genuinely well &mdash; recovers on its own</td></tr>
          <tr><td class="sw"><i class="sw-integrated"></i></td><td class="lvl">Integrated</td><td>holds itself, and gives more than it takes</td></tr>
        </table>
...
{{MEANING_BODY}}
    ...
    <a class="btn" href="https://lifestackconsulting.co.uk/contact-us/" target="_blank" rel="noopener">Book your first conversation &rarr;</a>
